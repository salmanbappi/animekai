...
package gradle.kotlin.dsl.plugins._06d92af5fec54aadc4f85e71efe94493
...
/**
 * The `org.jmailen` plugin group.
 */
@org.gradle.api.Generated
internal
class `OrgJmailenPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `org.jmailen`.
 */
internal
val `OrgPluginGroup`.`jmailen`: `OrgJmailenPluginGroup`
    get() = `OrgJmailenPluginGroup`(plugins)


/**
 * The `org.jmailen.kotlinter` plugin implemented by [org.jmailen.gradle.kotlinter.KotlinterPlugin].
 */
internal
val `OrgJmailenPluginGroup`.`kotlinter`: PluginDependencySpec
    get() = plugins.id("org.jmailen.kotlinter")
